...
public class xMinerOverlay extends Overlay
{
    private final Client client;
    private final xMinerPlugin plugin;
    private final xMinerConfig config;
    private final PanelComponent panelComponent = new PanelComponent();

    @Inject
    private xMinerOverlay(Client client, xMinerPlugin plugin, xMinerConfig config)
    {
        this.client = client;
        this.plugin = plugin;
        this.config = config;
        ...
        this.getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "xMiner Overlay"));
    }
    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        tableComponent.addRow("X-HOOK xMiner Plugin");
